...
const sendOTP = (email, otp, phone) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    if (email) {
        const transporter = nodemailer_1.default.createTransport({
            service: process.env.Farming_HOUSE_PROVIDER,
            host: process.env.Farming_HOUSE_HOST,
            port: 587,
            secure: false,
            auth: {
        ...
        const mailOptions = {
            from: `Farming App <farmingproductscmr@gmail.com>`,
            to: email,
        ...
        <p>Thanks,<br>Farming App Team</p>
      `,
        };
